...
function loadStoredDateTime() {
  ...
  const btn1 = document.getElementById("selectbtn1");
  const btn2 = document.getElementById("selectbtn2");
  const btn3 = document.getElementById("selectbtn3");

  btn1.onclick =function(){
    btn1.classList.add("btn-set-select");
    btn2.classList.remove("btn-set-select");
    btn3.classList.remove("btn-set-select");
  }

  btn2.onclick =function(){
    btn1.classList.remove("btn-set-select");
    btn2.classList.add("btn-set-select");
    btn3.classList.remove("btn-set-select");
  }
  ...
  btn3.onclick =function(){
    btn1.classList.remove("btn-set-select");
    btn2.classList.remove("btn-set-select");
    btn3.classList.add("btn-set-select");
  }
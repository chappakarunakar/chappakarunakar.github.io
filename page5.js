...
function loadStoredDateTime() {
  ...
  const btn1_select = document.getElementById("btn1");
  const btn1_select2 = document.getElementById("btn2");

  btn1_select.addEventListener('click',function(){
    btn1_select.classList.add('btn-set-select');
    btn1_select2.classList.remove('btn-set-select');
  });

  btn1_select2.addEventListener('click', function(){
    btn1_select.classList.remove('btn-set-select');
    btn1_select2.classList.add('btn-set-select');
  });